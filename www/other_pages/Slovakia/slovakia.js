...
$.getJSON('https://raw.githubusercontent.com/owid/covid-19-data/master/public/data/vaccinations/vaccinations.json', function(data) {
    ...
    console.log(data[189].data[data[189].data.length - 1])
    // day.innerHTML = data[168].data[327]["daily_vaccinations"]
    today_vaccinations.innerText = "Daily vaccinations: " + data[189].data[data[189].data.length - 1]["daily_vaccinations"]
    today_people_vaccinated.innerHTML = "Daily people vaccinated: " + data[189].data[189]["daily_people_vaccinated"]
    people_fully_vaccinated.innerHTML = "People fully vaccinated: " + data[189].data[189]["people_fully_vaccinated"]
    people_vaccinated.innerHTML = "People vaccinated: " + data[189].data[189]["people_vaccinated"]
});